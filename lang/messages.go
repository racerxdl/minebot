...
// FROM https://github.com/CloudburstMC/Language/blob/master/pt_BR.lang
...
var formatter = regexp.MustCompile(`\%([a-zA-Z\.]*)`)

func FormatString(lang, msg string) string {
	matched := GetString(lang, msg)
	if matched != msg {
		return matched
	}
	if !formatter.MatchString(msg) {
		return msg
	}
	matches := formatter.FindAllString(msg, -1)
	for _, match := range matches {
		msg = strings.ReplaceAll(msg, match, GetString(lang, match[1:]))
	}
	return msg
}
...
var PTBR = map[string]string{
	...
	"accessibility.screenName.editCharacter":     "Tela de Edição de Personagem ",
	...
	"accessibility.screenName.pause":             "Tela de Pausa  ",
	...
	"accessibility.start.feedback":   "Enviar feedback  ",
	...
	"accessibility.text.period.url":    "Ponto        ",
	...
	"accessibility.gamepad.bumper.right":       "Bumper direito ",
	"accessibility.gamepad.bumper.left":        "Bumper esquerdo ",
	...
	"achievementScreen.reward":               "Prêmio ",
	...
	"authentication.pleaseSignIn":                     "Você deve entrar com a sua conta escolar para jogar Minecraft: Education Edition. ",
	...
	"codeScreen.editor.description.makeCode": "O Microsoft MakeCode dá vida à ciência da computação com Minecraft ",
	...
	"codeScreen.needCheats":                  "Para codificar, os cheats devem estar ativados no nível.  ",
	"codeScreen.networkError":                "Não foi possível se conectar à rede. Verifique suas configurações de rede.  ",
	"codeScreen.resetWarning":                "Tem certeza de que deseja redefinir o Criador de Código? Você perderá todo o trabalho não salvo...  ",
	...
	"commands.reload.description":                       "Recarrega todos os arquivos de função de todos os pacotes de comportamentos.  ",
	"commands.reload.success":                           "Os arquivos de função existentes foram recarregados. Reinicie o Minecraft para recarregar NOVAS funções.  ",
	...
	"commands.structure.y.tooLow":                        "Não é possível colocar blocos fora do mundo. Experimente um valor de 0 ou superior para o componente Y de <to: x y z>.  ",
	...
	"container.smithing_table.upgrade":   "Engrenagem de Atualização  ",
	...
	"createWorldUpsell.signIn":           "Criar Realm com Conta da Microsoft ",
	...
	"createWorldScreen.experimentalbiomes":             "Criação de Biomas Personalizados ",
	"createWorldScreen.experimentalmodding":            "Recursos Adicionais para Mods ",
	"createWorldScreen.experimentalholiday":            "Recursos de Criador de Férias ",
	...
	"createWorldScreen.createOnRealms":                 "Criar nos Realms ",
	...
	"createWorldScreen.check_internet_connection":      "Você não está conectado à internet. Seus amigos não poderão ingressar em seus mundos multijogador. Entre com sua conta da Microsoft para jogar com seus amigos. ",
	"createWorldScreen.disconnectedXboxLive":           "Você não está conectado aos serviços da Microsoft. Seus amigos com Gamertags não poderão ingressar em seu mundo multijogador. Entre com sua conta da Microsoft para jogar com seus amigos. ",
	...
	"realmsInvitationScreen.shareDialogNewCodeButton": "Criar novo código ",
	...
	"realmsInvitationScreen.shareByLink":              "Compartilhar link  ",
	"realmsInvitationScreen.shareByCode":              "Compartilhar código de convite ",
	"realmsInvitationScreen.shareLinkToRealm":         "Compartilhar link do Realm  ",
	"realmsInvitationScreen.shareCodeToRealm":         "Compartilhar código de convite para Realm ",
	...
	"realmsInvitationScreen.shareInfoMessageCode":     "Qualquer pessoa que tenha o código de convite pode se juntar ao seu Realm. Acesse Jogo > Baixar Mundo para fazer download de um backup do seu mundo.  ",
	"realmsInvitationScreen.refreshLinkInfoMessage":   "Isso invalida o link antigo e cria um novo. Deseja continuar? ",
	"realmsInvitationScreen.refreshCodeInfoMessage":   "Isso invalida o código de convite antigo e cria um novo. Deseja continuar?  ",
	...
	"realmsSharingScreen.failedSignInModalMessage": "Você precisa entrar com uma conta da Microsoft para ingressar em um Realm. Entre e tente novamente.  ",
	...
	"realmsCreateScreen.incomplete.create.b":                 "Parece que você começou a criar um realm com uma conta da Microsoft diferente. Deseja concluir a criação daquele realm com essa conta da Microsoft como o proprietário?  ",
	"realmsCreateScreen.incomplete.create.c":                 "Alguém começou a criar um Realm com a conta de cobrança neste dispositivo.  Deseja concluir a criação daquele Realm com essa conta da Microsoft como proprietário? ",
	...
	"realmsCreateScreen.incomplete.renew.b":                  "Parece que você começou a renovar um realm com uma conta da Microsoft diferente.  Deseja concluir a renovação daquele realm com essa conta da Microsoft como proprietário?  ",
	"realmsCreateScreen.incomplete.renew.c":                  "Alguém começou a renovar um realm com a conta de cobrança deste dispositivo.  Deseja concluir a renovação daquele realm com essa conta da Microsoft como proprietário?  ",
	...
	"networkWorld.connect_to_xbl":                        "Entre com uma conta da Microsoft para jogar com amigos. ",
	...
	"networkWorld.multiplayerPrivilegesBlockedOnConsole": "Você não pode jogar no modo multijogador online devido à forma como a sua Conta Microsoft está configurada. Certifique-se de que suas configurações de segurança online permitam Multijogador e sua assinatura do Xbox Live Gold esteja ativa. Veja as instruções sobre como alterar essas configurações em aka.ms/MCMultiplayerHelp.  ",
	...
	"xblLogin.LoginMessageTitle": "Conta da Microsoft ",
	"xblLogin.LoginMessage":      "Conectando... ",

	"xbl.savePurchase.description.line1":  "Deseja jogar com o que comprou em qualquer sistema com a Loja Minecraft? Entre com uma conta GRATUITA da Microsoft e sincronize as Capas, Texturas, Mapas e Mash-ups que você comprou para usar e jogar no Minecraft!  ",
	"xbl.savePurchase.description.line2":  "Se você perder seu sistema ou desinstalar o Minecraft, suas compras ainda estarão sincronizadas e acessíveis em qualquer sistema quando você usar sua conta da Microsoft.  ",
	"xbl.savePurchase.leaveOnDevice":      "Deixar no dispositivo  ",
	"xbl.savePurchase.title":              "Salvar compras em uma conta da Microsoft?  ",
	"xbl.savePurchase.saveButton":         "Salvar na conta da Microsoft  ",
	"xbl.savePurchase.toast.title":        "Sucesso! ",
	"xbl.savePurchase.toast.message":      "Compras sincronizadas com a conta da Microsoft!  ",
	"xbl.savePurchase.inProgress.message": "Transferindo compras para a conta da Microsoft... ",

	"xbl.syncIAP.title":                         "Sincronizar compras com a Conta Microsoft?  ",
	"xbl.syncIAP.description":                   "Entre com uma conta da Microsoft para sincronizar suas Capas, Pacotes de Texturas, Mundos e Mash-ups. Eles ficarão disponíveis em todos os dispositivos em que você joga Minecraft. ",
	"xbl.syncIAP.syncNow":                       "Sincronizar Agora...  ",
	"xbl.syncIAP.syncLaterEllipsis":             "Sincronizar Depois... ",
	"xbl.syncIAP.syncLater":                     "Sincronizar Depois  ",
	"xbl.syncIAP.toast.title":                   "Sucesso!  ",
	"xbl.syncIAP.toast.message":                 "Compras sincronizadas com a sua conta da Microsoft! ",
	"xbl.syncIAP.inProgress.message":            "Sincronizando compras com a sua conta da Microsoft...  ",
	"xbl.syncIAP.skipSignIn.prompt.description": "Esta conta da Microsoft não será a conta principal deste dispositivo caso você não sincronize as compras dele com a conta. Você não entrará automaticamente quando iniciar o Minecraft. ",

	"xbl.syncIAP.confirmSync.prompt.title":             "Sincronizar com %s?  ",
	"xbl.syncIAP.confirmSync.prompt.description.line1": "Deseja sincronizar suas compras da loja de apps com %s?  ",
	"xbl.syncIAP.confirmSync.prompt.description.line2": "Você só pode sincronizar pacotes comprados fora do Marketplace do Minecraft uma vez. Eles continuarão disponíveis para qualquer um que jogar neste dispositivo.  ",
	"xbl.syncIAP.confirmSync.prompt.yes":               "Sim, Sincronize Minhas Compras ",

	"xbl.transferEntitlements.error.title":         "Erro na Conta  ",
	"xbl.transferEntitlements.error.body.button":   "Há um erro na sua conta. Você não conseguirá usar o Marketplace até resolvermos o problema. Se ele persistir por muitos dias, entre em contato com o suporte usando o botão de ajuda.  ",
	"xbl.transferEntitlements.error.body.nobutton": "Há um erro na sua conta. Você não conseguirá usar o Marketplace até resolvermos o problema. Se ele persistir por muitos dias, entre em contato com o suporte.  ",
	"xbl.transferEntitlements.error.buttontext":    "help.mojang.com ",
	"xbl.transferEntitlements.error.errortitle":    "Lista de Erros: ",
	"xbl.transferEntitlements.error.error1":        "Número do Erro  ",
	"xbl.transferEntitlements.error.error2":        "Número do ID  ",

	"playfab.account.banned.title":       "Banido(a)  ",
	"playfab.account.banned.body":        "Você foi banido do Minecraft. Enquanto seu banimento estiver em vigor, você não poderá jogar em seus mundos (em determinadas plataformas), jogar em servidores, entrar em Realms, hospedar ou entrar em jogos multijogador ou usar o Marketplace. Se você está pagando por um Reino, precisará cancelar sua assinatura na loja em que ela foi comprada. ",
	"playfab.account.banned.body.button": "Mais Informações ",

	"store.sign_in_warning.no_xbl_and_local_content":          "Importante! Você comprou pacotes e/ou Minecoins que estão disponíveis somente neste dispositivo e que podem ser perdidos em caso de mau funcionamento, perda do dispositivo ou caso o Minecraft seja desinstalado! Entre usando uma conta da Microsoft (grátis) e transfira a titularidade dos pacotes e Minecoins para ela para proteger os itens e ter acesso a eles em qualquer dispositivo que usar a conta. ",
	...
	"store.sign_in_warning.no_xbl_and_no_local_content.line2": "Entre usando uma conta da Microsoft (grátis) e transfira a titularidade dos pacotes e Minecoins para ela para proteger seus pacotes e Minecoins comprados.  ",
	...
	"xbl.skipSignIn.prompt.description": "Esta conta da Microsoft não será a conta principal deste dispositivo caso você não transfira as compras dele para esta conta. Você não entrará automaticamente quando iniciar o Minecraft.  ",
	"xbl.signOut.title":                 "Compras na conta da Microsoft!  ",
	"xbl.signOut.message1":              "Enquanto estiver desconectado da sua conta da Microsoft, você não terá acesso aos Minecoins e itens comprados na loja. ",
	...
	"dayOneExperience.carousel.marketplace":    "O Minecraft Marketplace é um local para encontrar novas capas, mundos, texturas e pacotes de mash-up de vários criadores talentosos.  ",
	"dayOneExperience.carousel.cross_platform": "Com o jogo entre plataformas, você pode se conectar a jogadores de outras plataformas. Entre na sua Conta da Microsoft para jogar com todos seus amigos do Minecraft!  ",
	...
	"disconnectionScreen.scriptNotSupported":                   "O mundo no qual você está tentando entrar requer um dispositivo que execute scripts. Como seu dispositivo não executa scripts no momento, não será possível usá-lo para entrar.  ",
	...
	"edu.templates.local_header":       "MEUS MODELOS: %1 ",
	"edu.templates.featured_header":    "MODELOS EM DESTAQUE ",
	"edu.templates.view_more":          "Ver mais modelos  ",
	"edu.templates.search_placeholder": "Buscar ",
	"edu.templates.created_by":         "Por %1 ",
	"edu.templates.quick_play":         "JOGAR  ",
	...
	"feature.pillageroutpost": "Posto do Saqueador  ",
	"feature.bastionremnant":  "Bastião Remanescente ",
	"feature.ruinedportal":    "Portal Arruinado ",
	...
	"gameTip.cameraMovement.mouse":                 "Mova :light_mouse_button: para olhar em volta. ",
	...
	"gameTip.playerMovement.keyboard":              "Pressione :_input_key.forward:, :_input_key.left:, :_input_key.back: ou :_input_key.right: para se mover. ",
	"gameTip.playerMovement.touch":                 "Toque :tip_touch_forward: :tip_touch_left: :tip_touch_back: :tip_touch_right: para se mover. ",
	"gameTip.playerMovement.controller":            "Mova :tip_left_stick: para se mover.  ",
	"gameTip.jumpMovement.keyboard":                "Pressione :_input_key.jump: para saltar.  ",
	"gameTip.jumpMovement.touch":                   "Toque :tip_touch_jump: para saltar.  ",
	"gameTip.jumpMovement.controller":              "Pressione :_input_key.jump: para saltar.  ",
	"gameTip.jumpForward.keyboard":                 "Pressione :_input_key.forward: e :_input_key.jump: para saltar para a frente.  ",
	"gameTip.jumpForward.touch":                    "Toque em :tip_touch_forward: e :tip_touch_jump: para saltar para a frente.  ",
	"gameTip.jumpForward.controller":               "Pressione :tip_left_stick: para cima e :_input_key.jump: para pular para a frente. ",
	"gameTip.findTree":                             "Encontre uma árvore para coletar madeira.  ",
	"gameTip.breakWood.mouse":                      "Segure :_input_key.attack: para partir madeira. ",
	"gameTip.breakWood.touch":                      "Toque e segure para quebrar a madeira.  ",
	"gameTip.breakWood.controller":                 "Pressione e segure :_input_key.attack: para partir madeira.  ",
	"gameTip.openInventory.keyboard":               "Pressione :_input_key.inventory: para abrir o seu inventário.  ",
	"gameTip.openInventory.touch":                  "Toque no botão :tip_touch_inventory: para abrir o seu inventário. ",
	"gameTip.openInventory.controller":             "Pressione :_input_key.inventory: para abrir o seu inventário.  ",
	"gameTip.selectWoodForMakePlank.keyboard":      ":light_mouse_left_button: para selecionar a madeira.  ",
	"gameTip.selectWoodForMakePlank.touch":         "Toque para selecionar a madeira. ",
	"gameTip.selectWoodForMakePlank.controller":    "Use :tip_left_stick: e :_gamepad_face_button_down: para selecionar a madeira. ",
	"gameTip.selectGridForMakePlank.keyboard":      ":light_mouse_left_button: na grade de criação.  ",
	"gameTip.selectGridForMakePlank.touch":         "Toque na grade de criação. ",
	"gameTip.selectGridForMakePlank.controller":    "Use :tip_left_stick: e :_gamepad_face_button_down: para colocar o material na grade de criação. ",
	"gameTip.selectOutputSlot.keyboard":            ":light_mouse_left_button: no espaço de saída para criar.  ",
	"gameTip.selectOutputSlot.touch":               "Toque no espaço de saída para criar. ",
	"gameTip.selectOutputSlot.controller":          "Pressione :_gamepad_face_button_down: no espaço de saída para criar.  ",
	"gameTip.selectHotBar.keyboard":                ":light_mouse_left_button: em um espaço vazio para adicionar ao seu inventário.  ",
	"gameTip.selectHotBar.touch":                   "Toque em um espaço vazio para adicionar ao seu inventário. ",
	"gameTip.selectHotBar.controller":              "Pressione :_gamepad_face_button_down: em um espaço aberto abaixo para adicionar ao seu inventário.  ",
	"gameTip.open.recipe.keyboard":                 ":light_mouse_left_button: aqui para abrir o livro de receitas. ",
	"gameTip.open.recipe.touch":                    "Toque aqui para abrir a aba de busca. ",
	"gameTip.open.recipe.controller":               "Pressione :tip_left_trigger: para abrir o livro de receitas. ",
	"gameTip.open.recipe.touchcontroller":          "Pressione :_input_key.jump: aqui para abrir a aba de busca. ",
	"gameTip.craftTable.keyboard":                  ":light_mouse_left_button: aqui para selecionar a receita da bancada.  ",
	"gameTip.craftTable.touch":                     "Toque aqui para selecionar a receita da bancada. ",
	"gameTip.craftTable.controller":                "Use :tip_left_stick: para selecionar a receita da bancada.  ",
	"gameTip.outputSlotCraftTable.controller":      "Pressione :_gamepad_face_button_down: para criar a bancada. ",
	"gameTip.selectHotBar.craftTable":              "Coloque a bancada na barra rápida para usá-la.  ",
	"gameTip.closeInventory.keyboard":              "Pressione :_input_key.inventory: ou :light_mouse_left_button: aqui para fechar o inventário.  ",
	"gameTip.closeInventory.touch":                 "Toque aqui para fechar o inventário. ",
	"gameTip.closeInventory.controller":            "Pressione :_gamepad_face_button_right: para fechar o inventário.  ",
	"gameTip.needMoreMaterials":                    "Você precisa de 2 Madeiras para fazer uma Picareta de Madeira.  ",
	"gameTip.selectItemInHotBar.keyboard":          "Use o :light_mouse_middle_button: ou as teclas de números para selecionar itens.  ",
	"gameTip.selectItemInHotBar.touch":             "Toque na barra rápida para selecionar itens. ",
	"gameTip.selectItemInHotBar.controller":        "Use :_input_key.cycleItemLeft: e :_input_key.cycleItemRight: para selecionar itens da barra rápida. ",
	"gameTip.placeCraftTable.keyboard":             ":_input_key.use: no chão para colocar uma bancada. ",
	"gameTip.placeCraftTable.touch":                "Toque no chão para colocar uma bancada. ",
	"gameTip.placeCraftTable.controller":           "Pressione :_input_key.use: para colocar uma bancada. ",
	"gameTip.useCraftTable.keyboard":               ":_input_key.use: numa bancada para usá-la. ",
	"gameTip.useCraftTable.touch":                  "Toque numa bancada para usá-la. ",
	"gameTip.useCraftTable.controller":             "Pressione :_input_key.use: numa bancada para usá-la. ",
	"gameTip.needPlanksAndSticks":                  "Você precisa de 3 tábuas e 2 gravetos.  ",
	"gametip.openSearchTab.keyboard":               ":light_mouse_left_button: aqui para abrir a aba de busca.  ",
	"gametip.openSearchTab.touch":                  "Toque aqui para abrir a aba de busca. ",
	"gametip.openSearchTab.controller":             "Pressione :_gamepad_face_button_down: aqui para abrir a aba de busca.  ",
	"gameTip.selectWoodenPickaxe":                  "Faça uma picareta de madeira para minerar pedras e carvão.  ",
	"gameTip.outputSlot.wooden.pickaxe.keyboard":   ":light_mouse_left_button: no espaço de saída para criar uma picareta de madeira. ",
	"gameTip.outputSlot.wooden.pickaxe.touch":      "Toque no espaço de saída para criar uma picareta de madeira.  ",
	"gameTip.outputSlot.wooden.pickaxe.controller": "Pressione :_gamepad_face_button_down: para criar uma picareta de madeira.  ",
	"gameTip.selectHotBar.wooden.pickaxe":          "Coloque a picareta na barra rápida para usá-la. ",
	"gameTip.hintsDone":                            "Você já pode explorar por conta própria. Divirta-se!  ",
	...
	"updateScreen.packs.updateRequired":       "Atualize para a versão mais recente para baixar seu pacote comprado no Marketplace de Minecraft.  ",
	...
	"howtoplay.blocks.text.7":   "Terracota - É encontrada naturalmente nos biomas de Ermo ou pode ser fabricada e colorida com Argila encontrada debaixo da água. Terracota pode se tornar Azulejo ao ser fundida numa Fornalha. ",
	"howtoplay.blocks.text.8":   "Magma - É encontrado naturalmente no Nether, emite uma pequena luz e queima quem pisar nele.  ",
	"howtoplay.blocks.text.9":   "Terra Infértil  ",
	...
	"howtoplay.chat":                 "chat ",
	"howtoplay.chat.title":           "Como Jogar: chat ",
	...
	"howtoplay.permissionBlocks.text.1":  "Minecraft: Education Edition tem vários blocos especiais que ajudam professores a criar e ensinar lições.  Apenas jogadores com a habilidade Construtor do Mundo podem colocar e destruir estes blocos.  Apenas jogadores sem a habilidade Construtor do Mundo estão sujeitos às restrições impostas por estes blocos.  ",
	...
	"howtoplay.permissionBlocks.text.6":  "Blocos de fronteira criam um campo de força que se estende para cima e para baixo infinitamente, independente da presença de outros blocos.  Os jogadores não podem passar através, por cima ou por baixo de um bloco de fronteira.  Os jogadores não podem colocar ou destruir blocos acima ou abaixo de um bloco de fronteira.  ",

	"howtoplay.chalkboard":              "Lousas ",
	"howtoplay.chalkboard.title":        "Como Jogar: Lousas ",
	"howtoplay.chalkboard.text.1":       "Lousas são usadas para mostrar texto no mundo.  Lousas mostram mais texto do que Placas, podem ser editadas depois de serrem colocadas e vêm em três tamanhos: Ardósia, Pôster e Quadro.  Uma lousa pode ser bloqueada para evitar que quem não é Construtor do Mundo a destrua ou edite.  Pressione :_input_key.use: em uma lousa existente para editá-la. ",
	"howtoplay.chalkboard.text.1.touch": "Lousas são usadas para mostrar texto no mundo.  Lousas mostram mais texto do que Placas, podem ser editadas depois de serrem colocadas e vêm em três tamanhos: Ardósia, Pôster e Quadro.  Uma lousa pode ser bloqueada para evitar que quem não é Construtor do Mundo a destrua ou edite.  Toque em uma lousa existente para editá-la.  ",
	...
	"howtoplay.dyes.text.2": "Alguns materiais de Corantes são mais difíceis de achar do que outros. A maioria dos Corantes pode ser criada com flores, como o Corante Vermelho de uma Papoula, mas alguns são encontrados de formas mais complexas, como:  ",
	...
	"howtoplay.dyes.text.6": "-O Corante Verde deve ser fundido de um Cacto.  ",
	"howtoplay.dyes.text.7": "-Farinha de Osso pode ajudar no crescimento de plantas e árvores ou virar Corante Branco. ",
	"howtoplay.dyes.text.8": "-Colete Bolsas de Tinta de Lulas para obter Corante Preto ",
	...
	"howtoplay.enderChest.title":  "Como Jogar: Baú do Ender ",
	...
	"howtoplay.gameSettings.text.8":   "-Seed: Este é um número exclusivo para o mundo. Ao colocar uma semente quando você cria um mundo novo, você pode controlar como ele será criado. Você também pode usar uma palavra ou uma frase para a semente e o jogo converterá em um número para você.  ",
	...
	"howtoplay.gameSettings.text.13":  "-Manter Inventário: Essa configuração permite que os jogadores conservem o inventário quando morrerem. ",
	"howtoplay.gameSettings.text.14":  "-Geração de Criatura: Impede que todas as criaturas sejam geradas quando esta configuração está desativada.  ",
	"howtoplay.gameSettings.text.15":  "-Vandalismo de Criaturas: Impede que as criaturas destruam o mundo.  ",
	"howtoplay.gameSettings.text.16":  "-Entidades Deixam Itens: Determina se objetos como carrinhos de minas e suportes de armaduras viram itens quando são quebrados.  ",
	"howtoplay.gameSettings.text.17":  "-Ciclo Climático: O Clima não vai mudar quando essa configuração estiver desativada. ",
	...
	"howtoplay.loom":          "Tear ",
	"howtoplay.loom.title":    "Como Jogar: Tear ",
	...
	"howtoplay.multiplayer.header.3":           "Ingressando em uma Partida Online  ",
	...
	"howtoplay.multiplayer.text.6":             "Observação: você deve estar conectado à internet para entrar com uma conta da Microsoft para jogar no modo multijogador. ",
	...
	"howtoplay.raids.title":    "Como Jogar: Ataques ",
	...
	"howtoplay.raids.text.3":   "Os aldeões muito provavelmente ficarão gratos por você tê-los salvo dos atacantes. Não deixe de falar novamente com eles, você pode fazer um bom negócio.  ",
	...
	"howtoplay.scaffolding.title":                       "Como Jogar: Andaime ",
	...
	"howtoplay.structureBlocks.title":           "Como Jogar: Blocos de Estrutura   ",                                                                                                                                                        // //
	...
	"howtoplay.structureBlocks.text.2":          "Para obter um Bloco de Estrutura, use o comando de barra /give. Para usar um Bloco de Estrutura, você deve ter permissões de Operador.   ",                                                 // //
	"howtoplay.structureBlocks.header.2":        " Modos   ",                                                                                                                                                                                 // //
	"howtoplay.structureBlocks.text.3":          "Os Blocos de Estrutura têm 3 modos, que podem ser alterados no menu suspenso Modo: Salvar, Carregar e Exportação em 3D.    ",                                                               // //
	...
	"howtoplay.structureBlocks.text.6":          "O modo Exportação em 3D é usado para exportar um arquivo de modelo 3D para plataformas compatíveis.  ",                                                                                     // //
	"howtoplay.structureBlocks.header.3":        "Janela Pré-Visualização    ",                                                                                                                                                               // //
	"howtoplay.structureBlocks.text.7":          "No lado direito da tela do Bloco de Estrutura, uma pré-visualização da área que você selecionou ou da estrutura que será carregada será exibida de acordo com o modo ativado do bloco.   ", // //
	"howtoplay.structureBlocks.text.8.keyboard": "Pressione :_input_key.attack: e arraste para girar a pré-visualização 3D.   ",
	"howtoplay.structureBlocks.text.8.gamepad":  "Use :_gamepad_stick_right: para girar a pré-visualização 3D.   ",
	"howtoplay.structureBlocks.text.8.touch":    "Toque e arraste a pré-visualização para girar a pré-visualização 3D. ",
	"howtoplay.structureBlocks.header.4":        "Ativação de Redstone   ",                                                                                                                                                                                                                  // //
	"howtoplay.structureBlocks.text.9":          "É possível usar Redstone para ativar um Bloco de Estrutura. Isso salva uma estrutura ou a carrega no mundo de acordo com o modo bloco e suas configurações.    ",                                                                          // //
	"howtoplay.structureBlocks.header.5":        "Integridade e Seed   ",                                                                                                                                                                                                                    // //
	"howtoplay.structureBlocks.text.10":         "Você pode alterar o quanto de uma estrutura é carregada alterando os valores de Integridade e Seed.   ",                                                                                                                                   // //
	"howtoplay.structureBlocks.text.11":         "Integridade: a porcentagem de blocos que serão carregados da estrutura. Os valores aceitos vão de 0 a 100. Os blocos serão escolhidos aleatoriamente se uma Seed não estiver especificada.  ",                                             // //
	"howtoplay.structureBlocks.text.12":         "Seed: o valor inserido aqui determina quais blocos devem ser removidos ao usar a Integridade. Deixe esse campo em branco se quiser que os blocos sejam escolhidos aleatoriamente.   ",                                                     // //
	"howtoplay.structureBlocks.header.6":        "Blocos Vazios de Estrutura   ",                                                                                                                                                                                                            // //
	"howtoplay.structureBlocks.text.13":         "Quando uma estrutura com blocos Vazios de Estrutura é carregada no mundo, os blocos que seriam removidos quando os blocos Vazios de Estrutura fossem carregados serão mantidos.   ",                                                       // //
	"howtoplay.structureBlocks.text.14":         "Exemplo: ao carregar um naufrágio vazio no fundo do oceano, ar geralmente é copiado em vez dos blocos de água. Se o naufrágio tiver sido preenchido com vazio de estrutura, a água permanecerá e você terá um navio com água dentro.    ", // //
	"howtoplay.structureBlocks.header.7":        "Detectar e Modo de canto   ",                                                                                                                                                                                                              // //
	"howtoplay.structureBlocks.text.15":         "Para selecionar automaticamente a área que deseja salvar, coloque blocos do Modo de canto ao redor da estrutura e dê a eles o mesmo nome da estrutura que deseja salvar.  ",                                                               // //
	"howtoplay.structureBlocks.text.16":         "Pressione o botão Detectar no Modo de salvamento encontrará todos os Blocos de canto com o mesmo nome e crie uma área de seleção para salvar tudo dentro do espaço demarcado por esses Blocos de canto. ",                                 // //
	...
	"howtoplay.theStore":                 "O Marketplace  ",
	"howtoplay.theStore.title":           "Como Jogar: O Marketplace  ",
	...
	"howtoplay.theStore.text.4.norealms": "Dê um novo visual ao seu jogo antigo com pacotes de texturas que podem ser colocados sobre seus mundos atuais! ",
	...
	"howtoplay.theStore.text.5.norealms": "Ou experimente todas elas com pacotes de mash-up que são coleções de capas, mundos e texturas que, quando combinados, vão transformar seus mundos! ",
	...
	"item.banner.illager_captain.name":              "Bandeira Illager ",
	...
	"item.warped_fungus_on_a_stick.name":            "Fungo Deformado no Graveto ",
	...
	"item.cooked_beef.name":                         "Bife Assado ",
	...
	"item.spawn_egg.entity.agent.name":              "Invocar Agent  ",
	"item.spawn_egg.entity.bee.name":                "Invocar Abelha ",
	"item.spawn_egg.entity.hoglin.name":             "Invocar Hoglin  ",
	"item.spawn_egg.entity.cat.name":                "Invocar Gato ",
	...
	"item.spawn_egg.entity.vindicator.name":         "Invocar Vingador  ",
	...
	"item.spawn_egg.entity.ravager.name":            "Invocar Devastador ",
	...
	"item.spawn_egg.entity.zombie_pigman.name":      "Invocar Piglin Zumbi ",
	"item.spawn_egg.entity.strider.name":            "Invocar Andarilho  ",
	...
	"item.spawn_egg.entity.panda.name":              "Invocar Panda  ",
	"item.spawn_egg.entity.pillager.name":           "Invocar Saqueador ",
	"item.spawn_egg.entity.piglin_brute.name":       "Invocar Piglin Bruto  ",
	"item.spawn_egg.entity.piglin.name":             "Invocar Piglin  ",
	"item.spawn_egg.entity.fox.name":                "Invocar Raposa ",
	"item.spawn_egg.entity.unknown.name":            "Invocar  ",
	"item.spawn_egg.entity.wandering_trader.name":   "Invocar o Comerciante Nômade  ",
	"item.spawn_egg.entity.zoglin.name":             "Invocar Zoglin  ",
	...
	"jigsaw.title.joint_type":         "Tipo de junta:  ",
	...
	"joincode.ip_entry.address.tooltip":           "Para encontrar o Endereço de IP, peça ao host para pausar o jogo. O Endereço de IP e o número da Porta podem ser encontrados na aba multijogador da tela de pausa.  ",
	"joincode.ip_entry.port.tooltip":              "Para encontrar o número da porta, peça ao host para pausar o jogo. O Endereço de IP e o número da Porta podem ser encontrados na aba multijogador da tela de pausa.  ",
	...
	"library.prompt.inGameLink":           "Fazer isso salvará e encerrará o jogo atual e todas as conexões de multijogadores. Tem certeza de que deseja sair?  ",
	"library.fetchingItem":                "Conectando à biblioteca... ",
	"library.fetchingItem.failed":         "Não foi possível encontrar este item na Biblioteca. ",
	"library.welcome.1":                   "Boas-vindas à Biblioteca do Minecraft: Education Edition! ",
	"library.welcome.2":                   "A Biblioteca é um recurso novo, criado para fazer com que professores e estudantes encontrem e importem conteúdo educacional de forma fácil diretamente no jogo. Nesta versão, você encontrará uma lista de alguns dos nossos mundos mais populares para importar e usar, junto com um link para a biblioteca completa de mundos no nosso site. ",
	"library.welcome.3":                   "Estamos trabalhando para adicionar suporte para mais tipos de conteúdo e funcionalidades nos próximos meses. Deixe sua opinião clicando no botão de comentários.  ",
	"library.item.sharepopup.title":       "Compartilhar  ",
	"library.item.sharepopup.shareLink":   "Compartilhar um link  ",
	"library.item.sharepopup.body":        "Compartilhar o link para este mundo. ",
	"library.item.sharepopup.copy":        "Copiar ",
	"library.item.sharepopup.copyButton":  "Copiar link  ",
	"library.item.sharepopup.shareButton": "Compartilhar com equipes  ",
	"library.item.share.toast.title":      "Link copiado para a área de transferência. ",
	"library.item.teams.msgTxt":           "Confira o mundo %1 em Minecraft: Education Edition. ",
	...
	"multiplayer.player.changeToSkin":          "%s mudou para a capa %s.  ",
	...
	"options.dev_showServerChunkMap":                                   "O mapa de chunks mostra chunks de servidor ",
	...
	"options.discoveryEnvironment.dev":                                 "Desenvolvimento  ",
	...
	"options.dev_sunsetting_tier.four":                                 "Nível 4 - TBD  ",
	...
	"options.hideKeyboardTooltips":                                     "Esconder dicas de teclado e mouse  ",
	...
	"options.raytracing.renderDistanceFormat":                          "%s porções  ",
	...
	"options.xboxliveBroadcastSettings":                                "Configurações da conta da Microsoft ",
	"options.xboxlivevisible":                                          "Visível para os jogadores da Xbox Live  ",
	"options.xboxLiveAccountSettings":                                  "Configurações da conta da Microsoft ",
	"options.xboxLiveSignedIn":                                         "Entrou com a conta da Microsoft  ",
	"options.xboxLiveSignedOut":                                        "Saiu da conta da Microsoft  ",
	...
	"options.achievementsDisabled.notSignedIn":              "As conquistas podem ser obtidas neste mundo, mas você deve entrar em conta da Microsoft para obtê-las. ",
	...
	"options.unlink_msa.confirm.warning":                    "AVISO: Você não poderá armazenar o progresso ou compras feitas em seu Sistema \"PlayStation 4\" em sua conta %s após desvincular.  ",
	"options.unlink_msa.confirm.warning.2":                  "Desvincular sua Conta da Microsoft de dentro deste jogo afetará todos os jogos de Minecraft nesta plataforma que usaram esta Conta da Microsoft. ",
	...
	"pauseScreen.xboxLiveDisconnect":   "Opa! Sua conta da Microsoft foi desconectada. Para convidar mais jogadores, entre no Menu Principal e reinicie seu mundo.  ",
	...
	"feedbackScreen.button":         "Comentários ",
	"feedbackScreen.title":          "Tem Comentários? ",
	"feedbackScreen.suggestion":     "Dar uma sugestão  ",
	"feedbackScreen.bug":            "Informar um bug  ",
	"feedbackScreen.help":           "Precisa de ajuda? ",
	"feedbackScreen.body":           "Você tem ideias para melhorar o Minecraft? Encontrou um bug que precisa ser corrigido? Ou precisa de ajuda com um problema? Conte para nós! ",
	"feedbackScreen.consoleMessage": "Visite esse website em outro dispositivo: %s  ",

	"feedbackScreen.suggestion.url.tts": "h t t p s dois pontos barra barra a k a ponto m s barra minecraft f b       ", // Text To Speech helper for a URL: https://aka.ms/minecraftfb - URL must remain the same for all LOCs!
	"feedbackScreen.bugs.url.tts":       "h t t p s dois pontos barra barra a k a ponto m s barra m c bugs            ", // Text To Speech helper for a URL: https://aka.ms/mcbugs - URL must remain the same for all LOCs!
	"feedbackScreen.help.url.tts":       "h t t p s dois pontos barra barra a k a ponto m s barra help M C            ", // Text To Speech helper for a URL: https://aka.ms/helpMC - URL must remain the same for all LOCs!
	"feedbackScreen.helpxbox.url.tts":   "h t t p s dois pontos barra barra a k a ponto m s barra help xbox         ",   // Text To Speech helper for a URL: https://aka.ms/helpxbox - URL must remain the same for all LOCs!
	...
	"permissions.MultiplayerSessions":                "Você não pode jogar no Realms devido à forma como a sua Conta Microsoft está configurada. Certifique-se de que suas configurações de segurança online permitam Multijogador e Clubes. Veja as instruções sobre como alterar essas configurações em aka.ms/MCMultiplayerHelp.  ",
	...
	"permissions.MultiplayerSessionsOnConsole":       "Você não pode jogar no Realms devido à forma como a sua Conta Microsoft está configurada. Certifique-se de que suas configurações de segurança online permitam Multijogador e Clubes, e se sua assinatura do Xbox Live Gold esteja ativa. Veja as instruções sobre como alterar essas configurações em aka.ms/MCMultiplayerHelp. ",
	...
	"permissions.nocheats.message":                   "Alguns comandos, como o teleporte, só ficam disponíveis com os cheats ATIVADOS.  Os cheats também podem ser ativados nas Configurações do Jogo no menu de pausa.  Se você ativar os cheats, as conquistas serão desativadas neste mundo. ",
	"permissions.nocheats.message.noachievements":    "Alguns comandos, como teleportar, estarão disponíveis somente quando os cheats estiverem ativados. Você também pode ativar os cheats no menu de pausa nas Configurações do Jogo.  ",
	...
	"permissions.title.settings.edu":                 "Nível de permissão para estudantes que ingressarem no seu mundo  ",
	...
	"progressScreen.message.unownedTemplate":                              "Parece que você não possui o modelo do Marketplace em que este mundo se baseia. Você pode comprá-lo no Minecraft Marketplace.  ",
	...
	"progressScreen.dialog.title.scriptConfirm":                           "Ativar Scripts? ",
	...
	"progressScreen.dialog.message.resourcePackOptional.rayTracing.line1": "Este mundo tem Pacotes de Recursos habilitados para ray tracing nele.   ",
	"progressScreen.dialog.message.resourcePackOptional.rayTracing.line2": "Seu dispositivo não é compatível com os recursos avançados de iluminação e textura, então você verá o mundo sem esses efeitos avançados. Gostaria de baixá-los antes de entrar?   ",
	"progressScreen.dialog.message.resourcePackRequired.rayTracing.line1": "Este mundo tem Pacotes de Recursos habilitados para ray tracing nele.   ",
	"progressScreen.dialog.message.resourcePackRequired.rayTracing.line2": "Seu dispositivo não é compatível com os recursos avançados de iluminação e textura, então você verá o mundo sem esses efeitos avançados. Gostaria de baixá-los antes de entrar? ",
	"progressScreen.dialog.message.scriptConfirm":                         "O mundo no qual você entrará contém scripts que são executados no dispositivo. Gostaria de entrar no mundo? ",
	...
	"progressScreen.dialog.button.joinAndDownload.onlyBehaviorPacks":      "Apenas Baixar Comportamentos e Entrar - %1 ",
	...
	"selectTemplate.signIn":                  "Criar Realm com Conta da Microsoft  ",
	...
	"selectTemplate.suggestedContent.title":  "Modelos do Marketplace em Destaque  ",
	...
	"skins.picker.expanded.back":           "Capas em \"%s\"  ",
	...
	"soundCategory.master":       "Principal  ",
	...
	"store.realmsPlus.buyFor":              "INSCREVA-SE AGORA %s  ", // Maximum 25 characters
	...
	"store.realmsPlus.noTrial.description":     "Seu Realm e os mais de 150 pacotes do Marketplace estarão disponíveis imediatamente. Até 10 jogadores podem jogar por vez, e eles recebem acesso aos mundos em seu Realm gratuitamente! Sua assinatura estará disponível durante 30 dias pelo preço de %s :minecoin:.  ",
	...
	"store.realmsPlus.landing.info1.line1": "- Seu próprio servidor de Realm pessoal – Um mundo contínuo sempre online para você e seus amigos! ",
	"store.realmsPlus.landing.info1.line2": "- Amigos jogam de graça no seu Realm ",
	"store.realmsPlus.landing.info1.line3": "- Vá do console ao celular ao PC, qualquer dispositivo com o Minecraft Marketplace é compatível  ",

	"store.realmsPlus.landing.info2.line1": "- Acesso gratuito a um catálogo de mais de 150 pacotes do Marketplace  ",
	"store.realmsPlus.landing.info2.line2": "- Mundos em seu Realm incluem backups seguros  ",
	"store.realmsPlus.landing.info2.line3": "- Seus primeiros 30 dias serão grátis  ",
	"store.realmsPlus.landing.info2.line4": "- Inscreva-se agora por %s/mês ",
	...
	"store.realmsPlus.faq.answer2":   "Um servidor pessoal permite que você crie um mundo compartilhado que fica sempre online e acessível por meio de qualquer dispositivo com o Minecraft Marketplace. Jogadores que você convidar para o seu Realm podem jogar neste mundo a qualquer momento. ",
	...
	"store.popup.downloadWorldTemplate.msg":                 "O modelo usado para criar este mundo está ausente.  O modelo continha um complemento necessário para continuar jogando neste mundo. ",
	...
	"store.purchase.bundle.partiallyOwnedWarning":           "Você já tem os seguintes pacotes: %s. Gostaria de desbloquear o restante dos pacotes deste conjunto?  ",
	...
	"store.content.requireXbl.signedIn":    "Faça download de graça com uma conta da Microsoft.  ",
	"store.content.requireXbl.notSignedIn": "Entre com uma conta da Microsoft para desbloquear. ",
	...
	"store.mashup.coutn.skins":         "%s Capas ",
	...
	"store.ratings.signIn.description2": "Antes de avaliar um item, você precisa entrar com uma conta da Microsoft. ",
	...
	"store.purchase.signInPart2":          "Entre com uma conta da Microsoft para começar a usar o Marketplace!  ",
	...
	"store.coins.incomplete.fulfill.b":            "Parece que você começou uma compra com uma conta diferente da Microsoft. Deseja concluir a compra com esta conta?  ",
	...
	"store.connection.failed.body":           "Não foi possível conectar ao Marketplace. Que tal verificar sua conexão à Internet?  ",
	...
	"store.inventory.no.xbl":                 "Meus Pacotes ",
	...
	"store.search.sort_menu.HighestPrice":  ":minecoin: do Maior para o Menor  ",
	"store.search.sort_menu.LowestPrice":   ":minecoin: do Menor para o Maior ",
	...
	"store.uploadWorldMessage":                          "Isso removerá o mundo atual do seu Realm e permitirá que você o substitua por um novo. Os membros do seu Realm não terão mais acesso ao seu mundo atual. Deseja continuar? ",
	...
	"tile.stripped_warped_hyphae.name":             "Hifas Deformadas Descascadas ",
	...
	"tile.light_block.name":                        "Bloco de Luz  ",
	...
	"tile.dirt.coarse.name":                        "Terra Infértil - É quase como um Bloco de Terra normal, mas não cresce Grama nele. Pode ser encontrado nos biomas de Savana e de Mega Taiga.  ",
	...
	"tile.lightning_rod.name":                      "Cajado de Raios ",
	...
	"tile.nether_brick.name":                       "Bloco de Tijolos do Nether ",
	"tile.red_nether_brick.name":                   "Bloco de Tijolos Vermelhos do Nether ",
	...
	"tile.planks.spruce.name":                      "Tábuas de Madeira de Pinheiro ",
	...
	"structure_block.export.disabled_message": "A função exportar está desativada em modelos de mundo do Marketplace do Minecraft.  ",
	...
	"worldConversionErrorPrompt.message.upload": "Algo deu errado. Não conseguimos converter o seu mundo. Você pode nos enviar seu mundo mais tarde indo para seu mundo antigo e pressionando :_gamepad_face_button_up:. Ou envie-nos seu mundo agora para podermos investigar mais a fundo.  ",
	...
	"trial.tabbed_upsell.xbl.title":                "Conta da Microsoft  ",
	...
	"trial.tabbed_upsell.creative.description":     "Compre o Minecraft e adquira o Modo Criativo! Acesse o inventário completo – o único limite para o que você pode construir é sua imaginação! Voe pelo mundo, crie sua casa dos sonhos usando tudo que desejar ou exploda um montanha usando Dinamite ilimitada!  ",
	...
	"trial.creative.mode.2.intro_description": "Você também terá acesso à Ilha da Inspiração, um mundo tutorial e a uma introdução ao Modo Criativo que ensinará você a ser um mestre construtor em tempo recorde! Você encontra mais mundos incríveis como esse no Marketplace do Minecraft. ",
	...
	// Xbox Live Strings
	"xbox.signin.error":                                 "Entre com sua conta da Microsoft para jogar com amigos, obter pontuação de jogador e conquistas.  ",
	...
	"xbox.signin.error.pocket.line3":                    "Durante este teste, todos precisarão entrar com uma conta da Microsoft para que possam receber convites e serem adicionados aos Realms.  ",
	"xbox.connection.error":                             "Desconectado da conta da Microsoft  ",
	"xbox.signin":                                       "Entrar  ",
	"xbox.signin.beta.blocked":                          "No momento, o login com uma Conta da Microsoft não está disponível na versão beta. ",
	"xbox.signin.enterCode":                             "E insira este código: ",
	"xbox.signin.letsPlay":                              "Vamos jogar! ",
	"xbox.signin.message":                               "Entre com a sua conta gratuita da Microsoft para vivenciar a experiência completa do Minecraft. ",
	...
	"xbox.signingin":                                    "Entrando com sua conta da Microsoft... ",
	"xbox.signingin.offline":                            "Entrando ",
	"xbox.firstsignin.line1":                            "Boas-vindas ao Minecraft! Use uma conta da Microsoft para começar a se conectar com a comunidade do Minecraft, onde PCs, consoles, celulares e tablets jogam juntos. E sabe qual é a melhor parte? ",
	"xbox.firstsignin.line2":                            "É DE GRAÇA!  ",
	"xbox.firstsignin.line3":                            "Não possui uma conta? Crie uma agora mesmo para obter conquistas e ingressar nos Realms e Servidores!  ",
	"xbox.firstsignin.line3.norealmsOrServers":          "Não possui uma conta? Crie uma agora mesmo para desbloquear conquistas e jogar com seus amigos de diversas plataformas!  ",
	"xbox.failedsignin.body":                            "Não foi possível entrar em sua conta Microsoft. O acesso ao Realms, Perfis e seus itens de Marketplace será limitado. Tente novamente mais tarde.  ",
	...
	"xbox.achievementssignin.line2":                     "Entre com uma conta da Microsoft para começar a obtê-los! ",
	"xbox.addfriendsignin.line1":                        "Encontre os amigos pelo Gamertag para ver quando eles estão online.  ",
	"xbox.addfriendsignin.line2":                        "Entre com uma conta da Microsoft para começar a adicionar amigos!  ",
	"xbox.invitesignin.line1":                           "Convide os amigos pelo Gamertag para conhecer seus mundos e saber quando eles estão online. ",
	"xbox.invitesignin.line2":                           "Entre com uma conta da Microsoft para começar a convidar amigos!  ",
	...
	"xbox.thirdpartysignin.line2":                       "Você precisa entrar com uma conta da Microsoft para se conectar!  ",
	...
	"xbox.disconectionscreen.notSignedIn":           "Entre com a sua conta da Microsoft para jogar com amigos. ",
	"xbox.disconectionscreen.multiplayerNotAllowed": "Esta conta da Microsoft não tem permissão para ingressar em jogos multijogador. ",
	...
	"tips.edu.8":  "Para usar o criador de código, pressione C no seu teclado ou toque no ícone de Agent no topo da sua tela!  ",
	...
	"tips.edu.16": "Você pode copiar e colar de um editor de texto para uma lousa, pôster ou quadro.  ",
	"tips.edu.17": "Você pode ligar e desligar as Dicas de Teclado e Mouse no menu Configurações em Controles.  ",
	...
	"tips.edu.20": "Escolha um Modo de Jogo Padrão ao criar o mundo para especificar o tipo de jogabilidade que você quer.  ",
	...
	"tips.game.1":  "Use erva marinha para atrair e reproduzir tartarugas marinhas.  ",
	"tips.game.2":  "Proteja os filhotes de tartaruga das criaturas hostis.  ",
	"tips.game.3":  "Os filhotes de tartaruga soltam escamas quando crescem – que podem ser usadas para criar cascos de tartaruga. ",
	"tips.game.4":  "Use uma cama para definir seu ponto de retorno durante o dia. ",
	"tips.game.5":  "Fermente algumas poções de respiração aquática para explorar embaixo d'água.  ",
	"tips.game.6":  "Os golfinhos podem guiar você até naufrágios e ruínas subaquáticas. Alimente-os com bacalhau e siga o rastro deles. ",
	"tips.game.7":  "Use tosquiadeiras para esculpir abóboras. ",
	"tips.game.8":  "Use membranas de fantasma para reparar o élitro.  ",
	"tips.game.9":  "Há 3.587 tipos de peixes tropicais. ",
	"tips.game.10": "O pepino-do-mar pode ser fundido em corante verde limão. ",
	"tips.game.11": "Use blocos de feno para reproduzir Lhamas. ",
	"tips.game.12": "As bússolas sempre apontam para uma Magnetita ou o ponto de invocação do mundo, crie uma para se guiar!  ",
	"tips.game.13": "Faça negócio com os aldeões para obter comida, ferramentas e até mesmo mapas do tesouro. ",
	"tips.game.14": "Você sabia que pode segurar um mapa na outra mão?  ",
	"tips.game.15": "Laços podem ser usados em barcos.  ",
	"tips.game.16": "Esgueire-se ou use as botas de passos gelados para andar com segurança em blocos de magma. ",
	"tips.game.17": "Você pode coletar teias de aranha usando tosquiadeiras.  ",
	"tips.game.18": "Precisa de diamantes? Tente minerar na coordenada Y 11!  ",
	"tips.game.19": "Antes de minerar diamantes, redstone ou ouro, confirme se você está usando uma picareta de ferro, diamante ou netherita, caso contrário não conseguirá o minério.  ",
	"tips.game.20": "Precisa de carvão para tochas ou combustível? Tente fundir toras de madeira na fornalha para fazer carvão vegetal. ",
	"tips.game.21": "Ouro é mais abundante em biomas de Ermo! ",
	"tips.game.22": "O élitro pode ser usado para voar. Encontre-o em navios da Cidade do End.  ",
	"tips.game.23": "Teste alguns recursos novos ativando Experimentos! ",
	"tips.game.24": "Os tridentes são dados pelo Afogado, e você pode segurá-los ou arremessá-los.  ",
	"tips.game.25": "Você pode criar Hoglins com Fungos Carmesim, mas é perigoso! ",
	"tips.game.26": "Você pode fundir 20 itens em uma fornalha usando blocos de alga desidratada como combustível.  ",
	"tips.game.27": "Os monstros que são mortos por flechas de esqueletos talvez deem discos de música. ",
	"tips.game.28": "Pessoas como VOCÊ fazem o conteúdo do Marketplace. ",
	"tips.game.29": "Você sabia que muitos criadores da comunidade ganham a vida com o conteúdo do Marketplace? ",
	"tips.game.30": "Você pode encontrar capas para personalizar sua experiência dentro do jogo ou usar as suas próprias em determinadas plataformas. ",
	"tips.game.31": "Os pacotes de textura mudam a aparência dos blocos, itens e até mesmo dos menus dentro do jogo. Experimente! ",
	"tips.game.32": "Acesse o Marketplace para descobrir novos mundos e aventuras.  ",
	"tips.game.33": "Inscreva-se para se tornar um Criador do Marketplace.  ",
	"tips.game.34": "Os pacotes de mash-up vêm com um mundo para explorar, capas, texturas e até mesmo novas músicas. ",
	"tips.game.35": "Você sabia que há mais de 500 pacotes criados pela comunidade no Marketplace e que esse número aumenta toda semana?  ",
	"tips.game.36": "Entre na discussão em discord.gg/Minecraft ",
	"tips.game.37": "Os minérios de esmeralda são os minérios mais raros no Minecraft. Eles são encontrados apenas em biomas de montanha extrema. ",
	"tips.game.38": "Não é necessário usar uma sela para domar um cavalo esqueleto. ",
	"tips.game.39": "As jaguatiricas mostram aos creepers quem manda. ",
	"tips.game.40": "Diorito: ame ou odeie. ",
	"tips.game.41": "Os fantasmas são criaturas perigosas que aparecem durante a noite. Lembre-se de dormir regularmente. ",
	"tips.game.42": "Os zumbis se transformarão em Afogados se afundarem na água. ",
	"tips.game.43": "O Minecraft acontece todo ano. Fique atento para o próximo.  ",
	"tips.game.44": "Usar fogos de artifício aumenta a velocidade do élitro durante o voo. Só... tome cuidado para eles não explodirem, senão você vai se machucar MUITO. ",
	"tips.game.45": "O ouro é mais comum nos biomas Nether e Ermo.  ",
	"tips.game.46": "As pessoas realmente leem isto?  ",
	"tips.game.47": "Maravilhas infinitas, possibilidades ilimitadas. ",
	"tips.game.48": "NÃO DEIXE ÁRVORES FLUTUANDO! ",
	"tips.game.49": "Aumente a velocidade na água para nadar. ",
	"tips.game.50": "O encantamento de rebentação impulsiona você no ar quando está chovendo. ",
	"tips.game.51": "O Minecraft Live é um evento por livestream mundial e interativo. Pegue seus itens e junte-se à festa! ",
	"tips.game.52": "Seja bom com os animais! ",
	"tips.game.53": "O Sinalizador é um item poderoso que só pode ser criado com uma estrela do Nether do Wither. ",
	"tips.game.54": "Não mate os golfinhos, seu monstro!  ",
	"tips.game.55": "Você sabia que estrelas do Nether não são destruídas por explosões?  ",
	"tips.game.56": "Ao cavar em direção reta, coloque uma tocha no pé para quebrar qualquer areia ou cascalho que poderia cair em você.  ",
	"tips.game.57": "Você pode trocar com Piglins.  ",
	"tips.game.58": "Corte uma Colmeia ou ninho para obter Favo de Mel, use uma Garrafa para obter mel. ",
	"tips.game.59": "Coloque uma Fogueira sob uma Colmeia ou ninho para colher mel pacificamente. Suas abelhas te agradecerão.  ",
	"tips.game.60": "Renascer no Nether requer uma Âncora de Renascimento carregada.  ",
	"tips.game.61": "Você pode carregar uma Âncora de Renascimento com Pedra Luminosa.  ",
	"tips.game.62": "Jogando no iOS, Android ou FireOS? Obtenha gratuitamente o Minecraft Original Music Pack do Marketplace para ter a experiência completa do Minecraft.  ",
	...
	"hbui.AchievementDetails.anotherPlatform":                       "Concluído em outra plataforma ",
	"hbui.AchievementDetails.completed":                             "Concluída ",
	"hbui.AchievementDetails.gamerscore":                            "Pontuação do jogador ",
	"hbui.AchievementDetails.locked":                                "Bloqueada  ",
	"hbui.AchievementDetails.yes":                                   "Sim ",
	"hbui.AchievementDetailsRoute.errorMessage":                     "Não foi possível carregar a conquista. Tente novamente ou verifique sua conexão com a Internet. ",
	"hbui.AchievementDetailsRoute.narration.completed":              "concluída  ",
	"hbui.AchievementDetailsRoute.narration.gamerscore":             "pontuação do jogador  ",
	"hbui.AchievementDetailsRoute.narration.loadingMessage":         "Carregando  ",
	"hbui.AchievementDetailsRoute.narration.locked":                 "bloqueada ",
	"hbui.AchievementDetailsRoute.narration.percentage":             "%[1]s de %[2]s  ",
	"hbui.AchievementDetailsRoute.narration.progress":               "progresso ",
	"hbui.AchievementDetailsRoute.narration.rewardLocked":           "recompensa bloqueada  ",
	"hbui.AchievementDetailsRoute.narration.rewardUnlocked":         "recompensa desbloqueada ",
	"hbui.AchievementDetailsRoute.narration.title":                  "detalhes da conquista  ",
	"hbui.AchievementDetailsRoute.reward":                           "Prêmio  ",
	"hbui.AchievementDetailsRoute.title":                            "Detalhes da Conquista  ",
	"hbui.AchievementDetailsRoute.titleNarration":                   "Tela de Detalhes da Conquista ",
	"hbui.AchievementDetailsRoute.viewReward":                       "Ver recompensa  ",
	"hbui.AchievementListItem.completed":                            "Concluída  ",
	"hbui.AchievementListItem.gamerscoreNarration":                  "pontuação do jogador %[1]s  ",
	"hbui.AchievementListItem.groupNarration":                       "Grupo %[1]s de %[2]s  ",
	"hbui.AchievementListItem.inProgress":                           "Em andamento  ",
	"hbui.AchievementListItem.locked":                               "Bloqueada ",
	"hbui.AchievementListItem.narrationCompleted":                   "%[1]s de %[2]s, desbloqueada, %[3]s pontuação do jogador ",
	"hbui.AchievementListItem.narrationLocked":                      "%[1]s de %[2]s, bloqueada, %[3]s pontuação do jogador ",
	"hbui.AchievementListItem.percentageNarration":                  "progresso de %[1]s% ",
	"hbui.AchievementListItem.rewardLockedNarration":                "Recompensa bloqueada ",
	"hbui.AchievementListItem.rewardUnlockedNarration":              "Recompensa desbloqueada  ",
	"hbui.AchievementListItem.siblingNarration":                     "Botão %[1]s de %[2]s  ",
	"hbui.AchievementListItem.view":                                 "Ver detalhes  ",
	"hbui.AchievementReward.narration.rewardLocked":                 "prêmio bloqueado  ",
	"hbui.AchievementReward.narration.rewardUnlocked":               "prêmio desbloqueado ",
	"hbui.AchievementReward.reward":                                 "Prêmio  ",
	"hbui.AchievementReward.viewReward":                             "Ver recompensa  ",
	"hbui.Achievements.all":                                         "Todas ",
	"hbui.Achievements.completed":                                   "Concluídas  ",
	"hbui.Achievements.completedEmptyText":                          "Conclua conquistas para admirá-las aqui. ",
	"hbui.Achievements.completedEmptyTitle":                         "Nada para ver aqui... ainda!  ",
	"hbui.Achievements.errorMessage":                                "Tente novamente ou verifique sua conexão com a Internet. ",
	"hbui.Achievements.errorMessageTitle":                           "Essa não! Não foi possível carregar as conquistas.  ",
	"hbui.Achievements.inProgress":                                  "Em andamento ",
	"hbui.Achievements.loading":                                     "Buscando Conquistas...  ",
	"hbui.Achievements.locked":                                      "Bloqueadas ",
	"hbui.Achievements.lockedEmptyText":                             "Você concluiu todas as conquistas.  ",
	"hbui.Achievements.lockedEmptyTitle":                            "Uau, você é incrível!  ",
	"hbui.Achievements.narration.loadingMessage":                    "Carregando ",
	"hbui.Achievements.narration.selected":                          "selecionado  ",
	"hbui.Achievements.narration.tab":                               "%[1]s, aba %[2]s de %[3]s  ",
	"hbui.Achievements.narration.title":                             "Tela de Conquistas  ",
	"hbui.Achievements.title":                                       "Conquistas  ",
	"hbui.AchievementsSummary.gamerscore":                           "Pontuação do jogador  ",
	"hbui.AchievementsSummary.hoursPlayed":                          "%[1]s horas ",
	"hbui.AchievementsSummary.narratorCompletedAchievements":        "%[1]s de %[2]s concluídas  ",
	"hbui.AchievementsSummary.narratorCompletedRewards":             "%[1]s de %[2]s recompensas  ",
	"hbui.AchievementsSummary.narratorGamerscore":                   "Pontuação do jogador %[1]s de %[2]s ",
	"hbui.AchievementsSummary.narratorIndex":                        "%[1]s de %[2]s ",
	"hbui.AchievementsSummary.narratorInProgress":                   "%[1]s em andamento ",
	"hbui.AchievementsSummary.narratorPercentage":                   "%[1]s% de progresso  ",
	"hbui.AchievementsSummary.narratorSummary":                      "Resumo de conquistas ",
	"hbui.AchievementsSummary.narratorTimePlayed":                   "Tempo jogado %[1]s horas ",
	"hbui.AchievementsSummary.percentage":                           "%[1]s de %[2]s concluído  ",
	"hbui.AchievementsSummary.progress":                             "Em andamento  ",
	"hbui.AchievementsSummary.rewards":                              "Recompensas  ",
	"hbui.AchievementsSummary.time":                                 "Tempo de jogo ",
	"hbui.BackButton.back":                                          "Voltar ",
	"hbui.BackButton.narration.backButton":                          "Botão Voltar ",
	"hbui.BaseTextField.deselect":                                   "Desmarcar ",
	"hbui.BaseTextField.select":                                     "Selecionar  ",
	"hbui.Button.button":                                            "botão  ",
	"hbui.CreateNewWorld.cheats.commandBlocksDescription":           "Habilita o uso de blocos de comando ",
	"hbui.CreateNewWorld.cheats.commandBlocksTitle":                 "Blocos de comando ",
	"hbui.CreateNewWorld.cheats.daylightCycleALwaysNoonDescription": "O tempo no jogo é congelado em meio-dia ",
	"hbui.CreateNewWorld.cheats.daylightCycleAlwaysNoonLabel":       "Sempre meio-dia ",
	"hbui.CreateNewWorld.cheats.daylightCycleLockDescription":       "O tempo no jogo está atualmente congelado ",
	"hbui.CreateNewWorld.cheats.daylightCycleLockLabel":             "Congelar tempo  ",
	"hbui.CreateNewWorld.cheats.daylightCycleNormalDescription":     "Normalmente, o tempo no jogo passa do dia para a noite  ",
	"hbui.CreateNewWorld.cheats.daylightCycleNormalLabel":           "Normal  ",
	"hbui.CreateNewWorld.cheats.daylightCycleTitle":                 "Ciclo da luz do dia ",
	"hbui.CreateNewWorld.cheats.description":                        "Personaliza o jogo com configurações de trapaça  ",
	"hbui.CreateNewWorld.cheats.educationDescription":               "Otimizado para PCs com RAM apropriada ",
	"hbui.CreateNewWorld.cheats.educationTitle":                     "Education Edition ",
	"hbui.CreateNewWorld.cheats.entitiesDropLoot":                   "Entidades deixam itens  ",
	"hbui.CreateNewWorld.cheats.entitiesDropLootDescription":        "Criaturas e algumas outras entidades deixam cair itens quando morrem ",
	"hbui.CreateNewWorld.cheats.inventoryDescription":               "Mantém todos os itens no inventário quando você morrer  ",
	"hbui.CreateNewWorld.cheats.inventoryTitle":                     "Manter inventário ",
	"hbui.CreateNewWorld.cheats.mobGriefingDescription":             "Certas criaturas são capazes de interagir com seu mundo ",
	"hbui.CreateNewWorld.cheats.mobGriefingTitle":                   "Vandalismo de criaturas ",
	"hbui.CreateNewWorld.cheats.mobSpawningDescription":             "Criaturas são invocadas naturalmente  ",
	"hbui.CreateNewWorld.cheats.mobSpawningTitle":                   "Geração de criaturas  ",
	"hbui.CreateNewWorld.cheats.regenerationDescription":            "Ganhe vida quando sua barra de fome estiver cheia  ",
	"hbui.CreateNewWorld.cheats.regenerationTitle":                  "Regeneração natural  ",
	"hbui.CreateNewWorld.cheats.settingsTitle":                      "Configurações de trapaça ",
	"hbui.CreateNewWorld.cheats.title":                              "Cheats ",
	"hbui.CreateNewWorld.cheats.weatherDescription":                 "Permite precipitação e tempestades  ",
	"hbui.CreateNewWorld.cheats.weatherTitle":                       "Ciclo climático ",
	"hbui.CreateNewWorld.title":                                     "Criar novo mundo  ",
	"hbui.ErrorModal.goBack":                                        "Voltar ",
	"hbui.ErrorModal.goingBack":                                     "Voltando à tela anterior... ",
	"hbui.ErrorModal.title":                                         "Ocorreu um erro ",
	"hbui.MenuButton.menu":                                          "Menu ",
	"hbui.MenuButton.toggle":                                        "Alternar menu  ",
	"hbui.Modal.close":                                              "Fechar modal ",
	"hbui.SectionList.groupNarration":                               "%[1]s, grupo %[2]s de %[3]s  ",
	"hbui.Switch.elementType":                                       "chave ",
	"hbui.Switch.off":                                               "desativada  ",
	"hbui.Switch.on":                                                "ativada  ",
	"hbui.Switch.toggle":                                            "Alternar ",
	"hbui.TabBar.notSelected":                                       "não selecionado ",
	"hbui.TabBar.open":                                              "Abrir  ",
	"hbui.TabBar.selected":                                          "selecionado  ",
	"hbui.TabBar.selectedTab":                                       "%[1]s de %[2]s  ",
	"hbui.TabBar.tab":                                               "tab ",
	"hbui.TextField.deselect":                                       "Desmarcar ",
	"hbui.TextField.select":                                         "Selecionar  ",
	"hbui.Toggle.count":                                             "%[1]s de %[2]s  ",
	"hbui.Toggle.elementType":                                       "seleção de opção  ",
	"hbui.Toggle.select":                                            "Selecionar ",
	"hbui.Toggle.selected":                                          "selecionado  ",
	...
	"contentlog.logLocationSectionName":  "Local do regsitro de conteúdo:  ",
	...
	"dr.classic_skins.custom_skin_description":           "Importe um arquivo de imagem do seu dispositivo para usar como capa. Ele não sincronizará entre dispositivos ou jogos. ",
	"dr.classic_skins.custom_skin_section_title":         "Importar ",
	"dr.classic_skins.invalidCustomSkin":                 "Isto não é uma capa do Minecraft.  ",
	...
	"dr.left":                                            "Lado esquerdo ",
	"dr.right":                                           "Lado Direito ",
	...
	"dr.categories.back_item":                            "Item Traseiro ",
	"dr.categories.face_item":                            "Item de Rosto ",
	...
	"dr.modal.persona_delete_confirm":                    "O personagem atual será excluído  ",
	...
	"onlinePlay.message":            "Durante o jogo online, você pode ser exposto a mensagens de chat ou outros tipos de conteúdo gerado por usuários que não tenha sido classificado e que pode não ser adequado para todas as idades. ",
	...
	"dr.color.air_force_blue":       "Azul Força Aérea  ",
	"dr.color.alex_green":           "Verde Alex  ",
	"dr.color.alex_mouth":           "Boca da Alex  ",
	"dr.color.alex_orange":          "Laranja Alex ",
	"dr.color.alex_skin":            "Pele da Alex ",
	"dr.color.amulet_green":         "Verde Amuleto ",
	"dr.color.auburn_red":           "Vermelho Rútilo ",
	"dr.color.bronco_vanilla":       "Branco Baunilha ",
	"dr.color.bronze_olive":         "Verde Bronze  ",
	"dr.color.brown_pod_black":      "Marrom Expresso  ",
	"dr.color.bunker_blueish_black": "Preto Bunker Azulado  ",
	"dr.color.cape_brown":           "Marrom Capa ",
	"dr.color.celery_green":         "Verde Aipo  ",
	"dr.color.chalky_blonde":        "Loiro Giz  ",
	"dr.color.cocoa_brown":          "Marrom Escuro  ",
	"dr.color.cool_brown_pod":       "Marrom Escuro Frio  ",
	"dr.color.cool_chocolate":       "Castanho Frio ",
	"dr.color.cool_melon":           "Rosa Melancia Frio  ",
	"dr.color.cool_tuft_bush":       "Bétula Fria ",
	"dr.color.cool_tuscany":         "Vermelho Toscano Frio ",
	"dr.color.copper_red":           "Vermelho Cobre  ",
	"dr.color.dark_brown":           "Marrom Escuro ",
	"dr.color.dark_brown_pod":       "Marrom Expresso Escuro  ",
	"dr.color.dark_comet_grey":      "Cinza Cometa Escuro  ",
	"dr.color.dark_red":             "Vermelho Escuro ",
	"dr.color.dark_salmon":          "Rosa Salmão Escuro ",
	"dr.color.dark_warm_madras":     "Rosa Madras Escuro Quente ",
	"dr.color.dark_warm_mikado":     "Avelã Escura Quente ",
	"dr.color.dutch_blonde":         "Loiro Holandês  ",
	"dr.color.green_house":          "Verde Caseiro  ",
	"dr.color.light_brown":          "Marrom Claro ",
	"dr.color.light_comet_grey":     "Cinza Cometa Claro  ",
	"dr.color.light_gold":           "Ouro Claro  ",
	"dr.color.light_jordy_blue":     "Azul Jeans Claro  ",
	"dr.color.magnolia_white":       "Branco Magnólia ",
	...
	"dr.color.minecraft_grey":       "Cinza Minecraft ",
	"dr.color.minecraft_light_blue": "Azul Claro Minecraft  ",
	"dr.color.minecraft_light_grey": "Cinza Claro Minecraft ",
	...
	"dr.color.muddy_waters":         "Granito Polido  ",
	"dr.color.nepal_grey_blue":      "Azul Acinzentado Nepal ",
	"dr.color.nugget_blonde":        "Loiro Pepita ",
	"dr.color.pale_brown":           "Bronzeado ",
	"dr.color.peach_orange":         "Laranja Pêssego ",
	"dr.color.purpleish_black":      "Preto Roxo ",
	"dr.color.salmon":               "Salmão  ",
	"dr.color.seal_brown":           "Crepúsculo Escuro ",
	"dr.color.spanish_white":        "Branco Espanhol  ",
	"dr.color.spring_rain_green":    "Verde Primavera  ",
	"dr.color.steve_blue":           "Azul Steve  ",
	"dr.color.steve_brown":          "Marrom Steve ",
	"dr.color.steve_mouth":          "Boca do Steve  ",
	"dr.color.steve_skin":           "Pele do Steve ",
	"dr.color.strawberry_blonde":    "Cobre Claríssimo ",
	"dr.color.tangaroa_dark_blue":   "Azul-Marinho Tangaroa ",
	"dr.color.vanilla":              "Baunilha ",
	"dr.color.warm_bisque":          "Bisque Quente  ",
